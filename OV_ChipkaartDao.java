...
public interface OV_ChipkaartDao {
	...
	public ArrayList<Integer> findByProductnummer(int productnummer) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException;
